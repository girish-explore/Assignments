...
import com.company.payment.paymentapi.uimode.ErrorDetails;
...
public class GlobalErrorHandler extends BaseController{
    ...
    public ResponseEntity<ErrorDetails> handleIllegalAccessException(Throwable th){
        
        String mess="SYS-ERR001"+UUID.randomUUID();
        ErrorDetails err=new ErrorDetails();
        err.setErrorMessage("System Error has Occurred");
        err.setErrCode(mess);
